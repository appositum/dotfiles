...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}\u@\h:λ\$ '
fi
...
### Git branch
# credits: https://gist.github.com/stuarteberg/4446426

# Colors for the prompt
blue="\033[01;34m"
red="\033[01;31m"
white="\033[01;37m"
white_thin="\033[0;37m"
green="\033[01;32m"
cyan="\033[01;36m"
reset="\033[00m"
...
if [ "$(id -u)" -ne 0 ];then
    PS1="$ps1_white\W\[\$(parse_git_branch_color)\]\$(parse_git_branch) $ps1_cyanλ$ps1_reset "
else
    PS1="$ps1_redλ $ps1_white\W\[\$(parse_git_branch_color)\]\$(parse_git_branch) $ps1_white#$ps1_reset "
    PS1="$ps1_white\W\[\$(parse_git_branch_color)\]\$(parse_git_branch) $ps1_redλ$ps1_reset "
fi

export PS1

echo -en "\e]0; $(hostname) λ $(dirs +0) \a"

# apt-vim
export PATH=$PATH:~/.vimpkg/bin

export REPOS=/home/${USER}/Documents/gitrepos
export VISUAL="vim"
